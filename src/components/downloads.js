...
export function renderDownloads() {
  ...
  section.innerHTML = `
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <!-- Access Cards Grid (2-Column Focused Layout) -->
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="p-6 rounded-xl bg-[#0e121a] border border-[#1e2638] flex flex-col justify-between hover-card">
          <div>
            ...
            <h3 class="text-base font-semibold text-white mb-1">iOS TestFlight</h3>
            <div class="font-mono text-[11px] text-slate-400 mb-3">
              Apple TestFlight Review &bull; Coming Soon
            </div>
            <p class="text-xs text-slate-400 leading-relaxed mb-6">
              Apple App Store / TestFlight review is currently pending. Track repo releases or star the project on GitHub for notifications.
            </p>
          </div>
          ...
          <div class="space-y-3">
            ...
            <div class="text-center text-[11px] font-mono text-slate-500 pt-1">
